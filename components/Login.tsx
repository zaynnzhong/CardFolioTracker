...
export const Login: React.FC<LoginProps> = ({ onBack }) => {
  ...
  const { signInWithGoogle, signInWithApple, signInAsGuest, sendOTP, verifyOTP, setupRecaptcha, sendPhoneCode, verifyPhoneCode } = useAuth();
          ...
          {loginMethod === 'email' && codeSent ? (
            ...
            <>
              ...
              <button
                ...
                className="w-full bg-black hover:bg-gray-900 text-white font-bold py-3.5 px-6 text-base rounded-xl flex items-center justify-center gap-3 transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed border border-gray-700"
              >
                {appleLoading ? (
                  <Loader2 className="animate-spin" size={20} />
                ) : (
